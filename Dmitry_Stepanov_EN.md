# **DMITRY STEPANOV**
**Backend Python Developer | Full Stack Engineer**

📧 stpnvdmtry@gmail.com | 📱 +996 (705) 231-784  
...
Backend Python Developer with 5+ years of professional experience specializing in Django/DRF web applications. Strong focus on clean architecture, best development practices, and comprehensive testing. Proven ability to build scalable platforms, refactor legacy systems, and deliver high-quality solutions across diverse domains including e-commerce, real estate, and government projects. Open to growth opportunities across various directions - technical, product, and organizational.
...
**Previously worked with:** Ruby (Ruby on Rails), PHP (Symfony, Laravel), Go
...
- **Integrated external services:** collaborated directly with third-party service developers to implement payment gateways, shipping APIs, and analytics tools
- Refactored legacy code to improve maintainability and test coverage
- Participated in code reviews and established API documentation standards

**Tech Stack:** Python, Django, DRF, React, Next.js, Angular, Laravel (PHP), PostgreSQL, Redis, Huey, AWS S3, Docker
...
- **Debugged and maintained Electron application** running on the typewriter device itself, working across Python backend and JavaScript device-side code
- Implemented WebSocket connections for real-time device status updates and configuration changes
- Created comprehensive logging and monitoring to diagnose sync issues and track device states in production

**Tech Stack:** Python, Django, Electron, PostgreSQL, WebSocket, REST API, Redis
...
- Built admin dashboard for restaurant staff to manage orders and inventory
...
- Enhanced platform performance through database indexing and query optimization
- Participated in migration planning as platform scaled to handle increased user load

**Tech Stack:** Python, Django, Flask, FastAPI, JavaScript, Angular, PostgreSQL, Redis, AWS (EC2, RDS, S3), Docker
...
- Developed bonus system with configurable rules engine for different user actions and achievements
- Created comprehensive admin panel for virtual world map management: defining zones, setting prices, managing ownership transfers
- Designed database schema to efficiently handle spatial data and ownership records
...
- **Created sophisticated referral system:** automated commission calculations based on referral activity, multi-level commission distribution
- Implemented rank progression system with dynamic tier upgrades based on user activity and cryptocurrency holdings
- Developed real-time transaction history and financial overview displays
- Integrated bank card payment processing for cryptocurrency purchases with proper security considerations

**Tech Stack:** Python (Flask, Django, FastAPI), JavaScript (Angular, React), PostgreSQL, Redis, OAuth 2.0, WebSocket

---

### **Freelance Developer & Side Projects**
*2016 - 2023*
...
- Maintained high system uptime and performance under production load
...
- Created full-stack application with responsive interface for browsing bills and participating in discussions
- **Tech Stack:** Python, Django, JavaScript, PostgreSQL
...
- **Tech Stack:** PHP, JavaScript, jQuery, WordPress, Drupal, MySQL

---

## **EDUCATION**

**Specialist Degree in Geology** | 2014  
Kyrgyz Mining and Metallurgical Institute named after Academician U. Asanaliev  
(Part of Kyrgyz State Technical University named after I. Razzakov)
